...
import { Modal, Button, Stack, Text, Textarea, Switch, Group, LoadingOverlay } from '@mantine/core'
  ...
  const handleSubmit = async (values: typeof form.values) => {
    ...
    try {
      const formData = {
        ...
        end_date: isIndefinite ? undefined : values.end_date?.toISOString().split('T')[0],
        ...
        <form onSubmit={form.onSubmit(handleSubmit)}>
          <Stack>
            <Text size="sm" c="dimmed">
              Seçilen Üye: <Text span fw={700}>{member?.first_name} {member?.last_name}</Text>
            </Text>
            ...
            <Group justify="flex-end" mt="md">
              ...
              <Button type="submit" color="cyan" loading={loading} leftSection={<IconSnowflake size={16} />}>
                Dondur
              </Button>
            </Group>
          </Stack>
